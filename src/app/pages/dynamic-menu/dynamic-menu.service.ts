...
export class DynamicMenuService {
    ...
    ///////////////////////////////////////////////
    /*** Ajout un menu dans la Liste des Menu ***/
    /////////////////////////////////////////////


    AddMenu(component: any, menuItems:Array<Menu>, menuItem) { 
        const newMenuItem = new Menu(parseInt(menuItem['id']), menuItem['title'], menuItem['routerLink'], menuItem['href'], menuItem['icon'], menuItem['target'], menuItem['hasSubMenu'], parseInt(menuItem['parentId']));
