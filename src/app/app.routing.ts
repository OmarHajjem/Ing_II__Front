...
export const routes: Routes = [
    ...
    { 
        ...
        children: [
            ...
            { path: 'mouvements', loadChildren: () => import('./pages/mouvement/mouvement.component').then(m => m.MouvementComponent), data: { breadcrumb: 'Mouvement' } },
            ...
            { path: 'test-menu', loadChildren: () => import('./TestMenu/menu-test.module').then(m => m.MenuTestModule), data: { breadcrumb: 'Test Menu' }  },
